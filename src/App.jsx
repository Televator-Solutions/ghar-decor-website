      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-[#0E1512]/90 backdrop-blur-lg border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-xs uppercase tracking-widest font-semibold text-slate-300">
            ...
            <a href="#reviews" className="hover:text-[#52B788] transition-colors">Reviews</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-[#16211C] border-b border-white/10 px-6 py-6 flex flex-col space-y-4">
            ...
            <a href="#gallery" onClick={() => setMenuOpen(false)} className="text-sm uppercase tracking-wider text-[#52B788] font-bold">Gallery</a>
            <a href="#reviews" onClick={() => setMenuOpen(false)} className="text-sm uppercase tracking-wider text-white">Reviews</a>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -bottom-6 -left-6 sm:-left-8 bg-gradient-to-r from-[#18261E]/95 to-[#121B16]/95 border border-[#52B788]/40 p-4 rounded-2xl shadow-2xl backdrop-blur-xl max-w-[280px] z-20">
      ...
      <section id="reviews" className="py-24 bg-[#0E1512] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <div className="flex items-center justify-center gap-1 text-[#52B788]">
              {[...Array(5)].map((_, i) => (
